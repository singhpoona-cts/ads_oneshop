...
WITH
  ...
  SELECT
    ...
    IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], '') AS product_type_full,
    ARRAY_LENGTH(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')) AS product_type_depth,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')[SAFE_ORDINAL(1)], '') AS product_type_1,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')[SAFE_ORDINAL(2)], '') AS product_type_2,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')[SAFE_ORDINAL(3)], '') AS product_type_3,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')[SAFE_ORDINAL(4)], '') AS product_type_4,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.product_types[SAFE_ORDINAL(1)], ''), ' > ')[SAFE_ORDINAL(5)], '') AS product_type_5,
    IFNULL(P.product.product_attributes.custom_label_0, '') AS custom_label0,
    IFNULL(P.product.product_attributes.custom_label_1, '') AS custom_label1,
    IFNULL(P.product.product_attributes.custom_label_2, '') AS custom_label2,
    IFNULL(P.product.product_attributes.custom_label_3, '') AS custom_label3,
    IFNULL(P.product.product_attributes.custom_label_4, '') AS custom_label4,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.google_product_category, ''), ' > ')[SAFE_ORDINAL(1)], '') AS product_category_1,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.google_product_category, ''), ' > ')[SAFE_ORDINAL(2)], '') AS product_category_2,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.google_product_category, ''), ' > ')[SAFE_ORDINAL(3)], '') AS product_category_3,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.google_product_category, ''), ' > ')[SAFE_ORDINAL(4)], '') AS product_category_4,
    IFNULL(SPLIT(IFNULL(P.product.product_attributes.google_product_category, ''), ' > ')[SAFE_ORDINAL(5)], '') AS product_category_5,
    P.in_stock,
    ...
    IFNULL(P.product.product_attributes.gtins[SAFE_ORDINAL(1)], '') AS gtin,
  FROM
