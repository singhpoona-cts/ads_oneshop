...
typecoders.registry.register_coder(schema_pb2.WideProduct, ProtoCoder)
typecoders.registry.register_coder(schema_pb2.Account, ProtoCoder)
typecoders.registry.register_coder(schema_pb2.ShippingSettings, ProtoCoder)
typecoders.registry.register_coder(
    schema_pb2.OmnichannelLiaSettings, ProtoCoder
)
...
def main(argv):
  ...
  with pipeline.Pipeline(options=opts) as p:
    ...
    def split_v1_product(p: dict[str, Any]) -> schema_pb2.WideProduct:
    ...
    def attach_pmax_campaign_ids(
      ...
      """
      annotated = schema_pb2.WideProduct()
      annotated.CopyFrom(product_row)
