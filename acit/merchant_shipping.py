...
def _get_account_shipping(client, account_id):
  ...
  """
    ...
    try:
        ...
        # Aggregators/MCAs are not valid targets
...
def download_shipping_settings(credentials,
                               account_ids,
                               mc_path,
  ...
  """
    ...
    def _process(account_id):
        ...
        # None (not accessible / no settings)
        # -> write nothing; downstream MEX LEFT
        ...
        output_file = (epath.Path(mc_path) / account_id / 'shippingsettings' /
                       'rows.jsonlines')
