...
class ProductTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        },
        {
            ...
            # we want to be cautious and report the product as untargeted
            # (`False`), even though this may be wrong. But we are forced
            # to take the wildcard targeting. This may result in
            # overreported product targeting.
            'expected': True,
        },
    )
