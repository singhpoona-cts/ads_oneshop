...
class MerchantAccountsTest(absltest.TestCase):
  ...
  def test_to_dict_renders_enums_as_strings(self):
    ...
    bi = ma.BusinessIdentity(
        promotions_consent=ma.BusinessIdentity.PromotionsConsent.PROMOTIONS_CONSENT_GIVEN
    )
    d = merchant_accounts._to_dict(bi)
