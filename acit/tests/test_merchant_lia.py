...
class MerchantLiaTest(absltest.TestCase):
    ...
    def test_to_dict_unset_state_is_unspecified(self):
        """An unset omnichannel sub-feature
        renders as the *_UNSPECIFIED enum name.
    ...
    def test_to_dict_lfp_link(self):
        """`posDataProvider` becomes `lfp_link`
        ...
        setting = ma.OmnichannelSetting(
            ...
            lfp_link=ma.LfpLink(
                lfp_provider=
                'accounts/123/omnichannelSettings/IN/lfpProviders/456',
